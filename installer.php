...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Fotonwebsite_cf268f585091dbc56431_20221009082649_archive.zip';
        const ARCHIVE_SIZE       = '43750778';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'cf268f5-09082649';
        const SECONDARY_PACKAGE_HASH = 'de74ad6-09082649';
        const VERSION            = '1.5.0';
